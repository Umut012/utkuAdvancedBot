...
.setColor('#ffffff') 
.setAuthor(`Nether Oto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:Nether:749380925619437619> Nether botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
